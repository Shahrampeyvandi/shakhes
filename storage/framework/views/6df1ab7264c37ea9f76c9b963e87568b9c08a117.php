...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendors/FontAwesome/all.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/home.css')); ?>" type="text/css">
...
<body>
    <div class="nav-bar">
        ...
        <div class="logo">
            <img src="<?php echo e(asset('assets/images/logo-site.svg')); ?>" alt="">
        </div>
        ...
        <div class="row mt-6">
            ...
            <div class="col-md-6">
                <div class="mt-md-5">
                    ...
                    <ul class="lists">
                        <li>
                            <img src="<?php echo e(asset('assets/images/tik.svg')); ?>" alt="">
                    ...
                    <div class="links col-md-8">
                        ...
                        <a href="">
                            <img src="<?php echo e(asset('assets/images/bazar.png')); ?>" alt="">
                        </a>
                        <a href="">
                            <img src="<?php echo e(asset('assets/images/google-play.png')); ?>" alt="">
                        </a>
                    </div>
            ...
            <div class="col-md-6 mt-5 mt-md-0">
                ...
                <img src="<?php echo e(asset('assets/images/trade.svg')); ?>" alt="">
        ...
        <section>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <img src="<?php echo e(asset('assets/images/app-screan1.png')); ?>" alt="">
                </div>
                <div class="col-md-3">

                    <img src="<?php echo e(asset('assets/images/app-screan2.png')); ?>" alt="">
                </div>
                <div class="col-md-3">

                    <img src="<?php echo e(asset('assets/images/app-screan3.png')); ?>" alt="">
                </div>
            </div>
        </section>
...
</html><?php /**PATH C:\xampp1\htdocs\shakhes\resources\views/Home/index.blade.php ENDPATH**/ ?>