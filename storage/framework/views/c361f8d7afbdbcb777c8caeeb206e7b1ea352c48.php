...
<div class="row">
    <div class="col-md-12">
        ...
        <form id="upload-file" method="post" action="<?php echo e(route('Clarification.Create')); ?>" >
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/Clarification/create.blade.php ENDPATH**/ ?>